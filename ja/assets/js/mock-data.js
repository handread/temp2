...
const YXDATA = (() => {
  ...
  const PRODUCTS = [
    ...
    { id:"p-10", cat:"ギフトカード", name:"颜汐 · 电子ギフトカード ¥1000", price:1000, originalPrice:null, tag:"電子カード", rating:5.0, sold:150, grad:["#fdf3e7","#c9a23c"], desc:"可用于抵扣任意医美施術或商城商品。" },
  ...
  const CHAT_RULES = [
    { kws:["你好","您好","在吗","hi","hello"], reply:"您好呀,我是颜汐 AI 客服小汐 👋 可以问我预约、施術价格、AI 皮肤检测或门店信息,也可以点击下方快捷问题~" },
